...
All system discovery, interpretation, and AI-assisted traversal MUST start from:
...
Prospera OS is an enterprise operating system in which all execution — including AI-assisted generation, automated processes, and human-initiated actions — is strictly governed by a non-overridable governance kernel.
...
A canonical definition of how strategy, governance, execution, and learning connect
